...
- [✔️] Plan and implement how you are going to manage your state for your application
- [✔️] You _must_ use either context or Redux as your state management system
- [✔️] Once you have planned out your state management system, fetch data from the smurf server and display the data it returns
